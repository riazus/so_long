...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/29 16:10:11 by jannabel          #+#    #+#             */
/*   Updated: 2022/01/29 16:16:50 by jannabel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_map(t_vars *vars)
{
	...
	if (!check_haters(vars->map.map))
		error_msg("We play with bonuses, so we need 1 hater", vars);
	return (SUCCESS);
}
